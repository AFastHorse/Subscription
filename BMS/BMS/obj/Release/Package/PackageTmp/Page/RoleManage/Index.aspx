<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Index.aspx.cs" Inherits="BMS.Page.RoleManage.Index" %>
        ...
        <div class="layui-card">
            ...
            <div class="layui-card-body">
                ...
                <script type="text/html" id="table-content-list">
                    <a class="layui-btn layui-btn-normal layui-btn-xs" lay-event="power"><i class="layui-icon layui-icon-edit"></i>权限管理</a>
            ...
            table.render({
                ...
                cols: [
                    [
                        ...
                        { field: "OrderNum", title: "排序号", width: 100, align: 'center' },
                ...
                switch (t.event) {
                    case "del":
                        layer.confirm("确定删除吗？", {
                            ...
                            $.ajax({
                                url: '/Page/RoleManage/RoleHandler.ashx?operation=Delete',
                                dataType: 'json',
                                type: 'Post',
                    ...
                    case "edit":
                        layer.open({
                            type: 2,
                            title: "编辑角色",
                            content: "/Page/RoleManage/Add.aspx?id=" + row.Id,
                            maxmin: true,
                            area: ["700px", "350px"],
                            btn: ["确定", "取消"],
                    ...
                    case "power":
                        layer.open({
                            type: 2,
                            title: "编辑权限",
                            content: "/Page/RoleManage/PowerManage.aspx?id=" + row.Id,
                            maxmin: true,
                            area: ["700px", "350px"],
                            btn: ["确定", "取消"],
                            yes: function (index, layero) {
            ...
            var active = {
                batchdel: function () {
                    ...
                    layer.confirm('确定删除吗？', {
                        ...
                        $.ajax({
                            url: "/Page/RoleManage/RoleHandler.ashx?operation=BatchDelete",
                            dataType: 'json',
                            type: 'Post',
                ...
                add: function () {
                    layer.open({
                        type: 2
                      , title: '新增角色'
                      , content: '/Page/RoleManage/Add.aspx'
                      , maxmin: true
                      , area: ['700px', '350px']
                      , btn: ['确定', '取消']
                      , yes: function (index, layero) {
