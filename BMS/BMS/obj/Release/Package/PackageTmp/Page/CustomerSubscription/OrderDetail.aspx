<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OrderDetail.aspx.cs" Inherits="BMS.Page.CustomerSubscription.OrderDetail" %>
    ...
    <script>
        layui.config({
            ...
            table.render({
                ...
                url: 'CustomerSubscription.ashx?operation=GetOrderDetail&OrderNo=<%=Request["OrderNo"]%>&r=' + Math.random(),
                cols: [
                    [
