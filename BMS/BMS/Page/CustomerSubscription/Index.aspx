<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Index.aspx.cs" Inherits="BMS.Page.CustomerSubscription.Index" %>
    ...
    <script>
        layui.config({
            ...
            table.render({
                ...
                url: 'CustomerSubscription.ashx?operation=GetList&r=' + Math.random(),
                cols: [
                    [
            ...
            var active = {
                export: function () {
                    window.location.href = 'CustomerSubscription.ashx?operation=ExportData&UserName=' + $('#txtName').val() + '&r=' + Math.random();
                }
            };
